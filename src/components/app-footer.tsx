...
export function AppFooter() {
  return (
    <footer className="bg-background/95 p-8 md:p-12 backdrop-blur-sm">
      <div className="mx-auto flex flex-col items-center justify-between gap-6 text-center text-muted-foreground sm:flex-row">
